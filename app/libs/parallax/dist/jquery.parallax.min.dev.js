...
(function (l, t) {
  ...
  function A(i, b) {
    ...
    this.setParallax = function (d, h, j, c) {
      ...
      for (c = 2; c--;) {
        k[c] = o.px.test(d[c]);
        if (typeof j[c] === "string") j[c] = o.percent.test(j[c]) ? parseFloat(j[c]) / 100 : v[j[c]] || 1;
        ...
        if (k[c]) {
          ...
          e[c] = d[c] === true ? 1 : o.percent.test(d[c]) ? parseFloat(d[c]) / 100 : d[c];
          a[c] = e[c] ? j[c] * (1 - e[c]) : 0;
        }
      }
    };
    ...
    this.getPointer = function () {
      for (var d = i.offsetParent(), h = i.position(), j = [], c = [], f = 2; f--;) {
        j[f] = k[f] ? 0 : h[f === 0 ? "left" : "top"] / (d[f === 0 ? "outerWidth" : "outerHeight"]() - this.size[f]);
        c[f] = (j[f] - a[f]) / e[f];
      }
  ...
  l.fn[n] = function (i) {
    ...
    return e.bind("freeze", function (a) {
      var g = l(this),
          ...
          c = o.percent.exec(a.y) ? parseFloat(a.y.replace(/%$/, "")) / 100 : a.y || h.pointer[1];
      a = a.decay;
      d.freeze = {
        pointer: [j, c]
      };
