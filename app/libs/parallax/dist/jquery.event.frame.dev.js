...
(function (jQuery, undefined) {
  ...
  function callHandler() {
    var fn = jQuery.event.special.frame.handler,
        ...
        array = this.array,
        l = array.length; // Give event object properties

    event.frameCount = this.frameCount; // Call handler on each elem in array
    ...
    jQuery.event.special.frame = {
      ...
      setup: function setup(data, namespaces) {
        if (timer) {
          ...
          timer.array = [this]; // Queue timer to start as soon as this thread has finished
      ...
      teardown: function teardown(namespaces) {
        var array = timer.array,
            l = array.length; // Remove element from list
